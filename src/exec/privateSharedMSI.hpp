...
public:
    ...
    /* set stats */
    inline void set_per_tile_stats(boost::shared_ptr<privateSharedMSIStatsPerTile> stats) { m_stats = stats; }
    inline bool stats_enabled() { return (m_stats != boost::shared_ptr<privateSharedMSIStatsPerTile>()); }
    inline boost::shared_ptr<privateSharedMSIStatsPerTile> stats() { return m_stats; }
...
private:
    ...
    typedef struct {
        ...
        boost::shared_ptr<coherenceMsg> dir_req;
        boost::shared_ptr<coherenceMsg> dir_rep;
        boost::shared_ptr<coherenceMsg> cache_req;
        boost::shared_ptr<coherenceMsg> cache_rep;
    ...
    typedef struct {
        ...
        boost::shared_ptr<coherenceMsg> cache_rep;
        vector<boost::shared_ptr<coherenceMsg> > dir_reqs;;
        boost::shared_ptr<coherenceMsg> dir_rep;
    ...
    void process_cache_rep(boost::shared_ptr<cacheLine> line, boost::shared_ptr<coherenceMsg> rep);
    ...
    boost::shared_array<uint32_t> GLOB; // printf

    cache* m_l1;
    cache* m_l2;
    boost::shared_ptr<cat> m_cat;

    boost::shared_ptr<privateSharedMSIStatsPerTile> m_stats;
    ...
    vector<boost::tuple<bool/* is a memoryRequest type */, boost::shared_ptr<void> > > m_to_cache_req_schedule_q; 

    /* scheduler queues for requests in to l2 work table */
    vector<boost::shared_ptr<coherenceMsg> > m_to_directory_req_schedule_q;
    vector<boost::shared_ptr<coherenceMsg> > m_to_directory_rep_schedule_q;

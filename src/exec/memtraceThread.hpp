...
public:
    ...
    /* set stats */
    inline void set_per_thread_stats(boost::shared_ptr<memtraceThreadStatsPerThread> stats) { m_stats = stats; }
    inline bool stats_enabled() { return (m_stats != boost::shared_ptr<memtraceThreadStatsPerThread>()); }
    inline boost::shared_ptr<memtraceThreadStatsPerThread> stats() { return m_stats; }
...
private:
    ...
    logger &log;
    boost::shared_ptr<memtraceThreadStatsPerThread> m_stats;

...
void crossbar::add_ingress(node_id src, boost::shared_ptr<ingress> ing) throw(err) {
...
void crossbar::add_egress(node_id dst, boost::shared_ptr<egress> egr) throw(err) {

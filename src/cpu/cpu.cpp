...
cpu::cpu(const pe_id &new_id, const uint64_t &new_time, boost::shared_ptr<mem> new_ram,
...
void cpu::connect(boost::shared_ptr<bridge> net_bridge) throw() { net = net_bridge; }
